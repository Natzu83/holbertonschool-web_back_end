#!/usr/bin/env python3
"""
Class to get data from the CSV file
...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    """
    Assuming that the 'page' represents the current page
...
class Server:
    """
    Caches the file of the most popular baby names
    from the CSV file named like the contents of
    'DATA_FILE'.

    Used to paginate the rows of data, and has a method
